...
| TP | 25/09/2024 | Russell Stephen Romero Qwistgaard | Implementación del bounded context Perfil <br> Agregar en el repositorio una rama del boundend context Perfil <br> Sprint Backlog 2 <br> Development Evidence for Sprint Review <br> Testing Suite Evidence for Sprint Review <br> Execution Evidence for Sprint Review <br> Services Documentation Evidence for Sprint Review <br> Software Deployment Evidence for Sprint Review |
| TB2 | 04/11/2024 | Pedro Jesús Nanfuñay Liza | Implementación del bounded context Author para Web Application <br> Desarrollo de la primera versión del Web Services <br> Sprint Planning 3 <br> Sprint Backlog 3 <br> Development Evidence for Sprint Review <br> Testing Suite Evidence for Sprint Review <br> Execution Evidence for Sprint Review <br> Services Documentation Evidence for Sprint Review <br> Software Deployment Evidence for Sprint Review <br> Team Collaboration Insights during Sprint |
...
|-------------------------|------------------------|------------------|
| Comunica oralmente con efectividad a diferentes rangos de audiencia. | Gómez Vallejos, Sergio André <br> TB1 <br> Presenté de manera clara y adaptada los avances y resultados del proyecto, asegurándome de que todos los miembros del equipo y las audiencias externas comprendieran los aspectos técnicos y estratégicos, lo que facilitó la toma de decisiones informadas. <br> TP1 <br> Presenté de manera clara y adaptada los avances y resultados del proyecto, asegurándome de que todos los miembros del equipo y las audiencias externas comprendieran los aspectos técnicos y estratégicos, lo que facilitó la toma de decisiones informadas. <br> <br> Nanfuñay Liza, Pedro Jesús <br> TB1 <br> Cumplí de manera satisfactoria el avance de los items que se me han asignado, demostrando responsabilidad y compromiso con la realización del proyecto y siempre dispuesto a apoyar a mis compañeros de equipo. <br> TP1 <br> Presenté de manera clara y adaptada los avances y resultados del proyecto, asegurándome de que todos los aspectos correspondieran con respecto a los aspectos técnicos y estratégicos identificados anteriormente, lo que permite a la audiencia comprender nuestro objetivo. <br> TB2 <br> Presenté satisfactoriamente los avances del proyecto, evidenciando compromiso con los aspectos y tareas que se me han asignado, con el objetivo de asegurar la comprensión de los objetivos a la audiencia, tomando aspectos correspondientes a nivel técnico. <br> <br> Salon Puerta, Merly <br> TB1 <br> Mantuve comunicación activa con los integrantes del equipo para la distribución equitativa del trabajo. Así mismo, desarrolé las actividades que me tocaron realizar manteniendo una comunicación activa con los responsables de las demás tareas. <br> | TB1: Se demostró una notable capacidad para presentar los avances y resultados del proyecto de manera clara y adaptada a las necesidades de diversos grupos. Su habilidad para comunicar aspectos técnicos y estratégicos de manera comprensible permitió a los miembros del equipo y a las audiencias externas tomar decisiones informadas, evidenciando una comunicación oral efectiva con diferentes rangos de audiencia. <br> TP1: Se demostró una notable capacidad para presentar los avances y resultados del proyecto de manera clara y adaptada a las necesidades de diversos grupos. Su habilidad para comunicar aspectos técnicos y estratégicos de manera comprensible permitió a los miembros del equipo y a las audiencias externas tomar decisiones informadas, evidenciando una comunicación oral efectiva con diferentes rangos de audiencia. <br> TB2: Se demostró satisfactoriamente el avance y resultados del desarrollo de los items correspondientes a nuestra plataforma y adaptada a nuestra audiencia, demostrando habilidades de comunicación con conocimientos técnicos y estratégicos al compartir la información y objetivos. |
Comunica por escrito con efectividad a diferentes rangos de audiencia. | Gómez Vallejos, Sergio André <br> TB1 <br> Redacté el informme sobre el proyecto, ajustando el lenguaje y la estructura para que fueran accesibles tanto para compañeros técnicos como para audiencias no técnicas, garantizando la comprensión y utilidad de la información compartida. <br> TP1 <br> Redacté el informe sobre el proyecto, ajustando el lenguaje y la estructura para que fueran accesibles tanto para compañeros técnicos como para audiencias no técnicas, garantizando la comprensión y utilidad de la información compartida. <br> <br> Pedro Jesús Nanfuñay Liza <br> TB1 <br> Redacté el avance de los items del presente proyecto manera satisfactoria, garantizando la fácil lectura para los usuarios, de esta manera se logra una mejor exposición de la información. <br> TP1 <br> Redacté el informe del proyecto, tomando en cuenta aspectos como el lenguaje y la estructura para que fueran accesibles para audiencias no técnicas, con el objetivo de garantizar la comprensión de la información compartida. <br> TB2 <br> Redacté el informe de manera satisfactoria que presentan los avances del proyecto correspondiente, tomando en cuenta nuestro objetivo y ajustando la información para garantizar la comprensión de la información. <br> <br> Salon Puerta, Merly <br> TB1 <br> Realicé las actividades que me tocó desarrollar de manera clara, procurando una correcta presentación al docente y a mis compañeros.<br> | TB1:  Se mostró competencia en la redacción del informe del proyecto, ajustando el lenguaje y la estructura del documento para que fuera accesible tanto para compañeros técnicos como para audiencias no técnicas. Su enfoque en garantizar la comprensión y utilidad de la información compartida refleja una habilidad efectiva para comunicar por escrito a diferentes rangos de audiencia.   <br> TP1:  Redacté el informe sobre el proyecto, ajustando el lenguaje y la estructura para que fueran accesibles tanto para compañeros técnicos como para audiencias no técnicas, garantizando la comprensión y utilidad de la información compartida. <br> TB2: Se redactó el informe garantizando la comprensión de los objetivos y avances respecto al desarrollo del proyecto, ajustando el lenguaje y estructura para que fueran accesibles tanto para compañeros técnicos como para audiencias no técnicas, garantizando la comprensión y utilidad de la información compartida. | 
...
| **Sprint n-1 Review Summary**        | Se logró el desarrollo y diseño de la primera versión del landing page para el proyecto BookSphere. Se completaron todas las funcionalidades básicas necesarias para la presentación inicial de la plataforma. Consideramos que hemos demostrado un excelente desempeño y tomaremos en cuenta retroalimentaciones brindadas al equipo para añadir funciones y/o aspectos que serán indispensables para la próxima entrega. |
| **Sprint n-1 Retrospective Summary** | Tras recibir retroalimentación del sprint anterior, hemos decidido en mejorar la experiencia del usuario y en integrar información que podría ser indispensable para atraer a los usuarios, de manera que la información sea lo más óptima posible y que permita una mayor interacción con los clientes. |
...
|---------|------------------------------------------|---------------------------------------------|----------------|-------------------------------|---------------------------------------------|
| US043   | Visualizar información sobre la plataforma | - Crear sección de "Características" (1 hora) <br> - Añadir texto (1 hora) <br> - Añadir iconos (1 hora) <br> - Añadir estilo de fuente e iconos (2 horas) | 5 | Gómez Vallejos Sergio André | Done |
| US044   | Acceder a información de contacto | - Crear sección "Contáctanos" en el archivo principal (1 hora) <br> - Añadir información (1 hora) <br> - Añadir estilos de fuente, íconos y links (2 horas) | 4 | Gómez Vallejos Sergio André   | Done |
| US045   | Navegar por la sección de testimonios  | - Crear sección "Testimonios" en el archivo principal (1 hora) <br> - Agregar información necesaria (1 hora) <br> - Agregar iconos de usuarios (30 min) <br> - Implementar función de desplazamiento horizontal (1 hora) <br> - Añadir estilos de fuente, tamaño e iconos (2 horas) | 5 | Gómez Vallejos Sergio André | Done |
| US046   | Entender cómo funciona la aplicación   | - Crear sección "Sobre Nosotros" en el archivo principal (1 hora) <br> - Añadir información necesaria (1 hora) <br> - Añadir imágenes respecto a la información (1 hora) <br> - Añadir estilo para las fuentes de letra, imágenes y organización (2 horas) <br> - Añadir función de desplazamiento horizontal (1 hora) <br> - Añadir botón en el menú principal para desplazarse a la sección rápidamente (1 hora)| 6 | Gómez Vallejos Sergio André | Done                                        |
| US047   | Descargar la aplicación | - Añadir sección "Descargar" en el archivo principal (1 hora) <br> - Añadir información (30 min) <br> - Añadir imágenes para descargas en tienda de aplicaciones disponibles (30 min) <br> - Añadir estilos para la sección (texto e imágenes) (1 hora) | 3 | Gómez Vallejos Sergio André | Done                                        |
| US049   | Visualizar la interfaz de la aplicación | - Implementar funciones para la visualización correcta en dispositivos desktop o móviles (3 horas) | 3 | Gómez Vallejos Sergio André | Done |
| US050   | Cambiar Idioma de la Interfaz | - Crear archivo para manejar los textos en inglés (en) y español (es) (1 hora) <br> - Crear función para cambiar de idioma (1 hora) <br> - Implementar botón desplegable en la página para cambiar de idioma (1 hora) <br> - Añadir estilo al botón (1 hora) | 4 | Gómez Vallejos Sergio André | Done |
...
| **Id**  | **Title**                                                | **Work-Item / Task**                                     | **Estimation** | **Assigned To**                  | **Status (To-do/In-Process/To-Review/Done)** |
|---------|----------------------------------------------------------|----------------------------------------------------------|----------------|----------------------------------|---------------------------------------------|
| US010 | Gestionar Comentarios y Reseñas | - Crear entidad Comment (30 min) <br> - Crear componente para mostrar los comentarios disponibles por libro e implementar función para responder a las mismas (1 hora) <br> - Crear componente para reportar y/o eliminar comentario (2 horas) <br> - Implementar componentes en el componente principal (Ver detalles del libro) (4 horas) | 7 horas | Nanfuñay Liza Pedro Jesús | Done |
| US011 | Acceder a Estadísticas de Lectura | - Crear entidad Statistics (30 min) <br> - Crear componente para visualizar estadísticas del libro seleccionado (3 horas) <br> - Implementar componente en el componente principal (1 hora) | 4 horas | Nanfuñay Liza Pedro Jesús | Done |
| US012 | Promocionar Libros en la Plataforma | - Crear entidad Promote (30 min) <br> - Crear componente para promocionar libro (2 horas) <br> - Implementar función para implementar etiquetas a los libros promocionados en Library (2 horas) <br> - Implementar botón para acceder al componente de Promocionar Libro desde Detalles del libro (1 hora) | 6 horas | Nanfuñay Liza Pedro Jesús | Done |
| TS016 | Implementar CRUD para libros | - Crear y definir los Value Objects (30 min) <br> Crear el aggregate Book (1 hora) <br> - Crear queries para obtener los libros (15 min) <br> - Crear commands para crear, actualizar y borrar los libros (15 min) <br> - Crear servicios para implementar los queries y commands (30 min) <br> - Crear repositorios para Book (30 min) <br> - Implementar los servicios para queries y commands (1 hora) <br> - Crear e implementar los resources (15 min) <br> - Crear un controlador para implementar funciones CRUD para los libros (2 horas) | 6 horas | Nanfuñay Liza Pedro Jesús | Done |
| TS017 | Implementar la búsqueda de libros | - Crear los record para obtener todos los libros, según el id y título (15 min) <br> - Crear un servicio para los queries de búsqueda de libros (30 min) <br> - Crear servicio para implementar los queries de búsqueda de libros (1 hora) <br> - Implementar los servicios en el controlador principal para los libros (2 horas) | 5 horas | Nanfuñay Liza Pedro Jesús | Done |
