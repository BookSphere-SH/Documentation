...
| ![entrevista_autor_1](https://acortar.link/iMMnZ8)|
...
| Story 007 | Dejar Reseña en un Libro               | **Como** usuario, **quiero** dejar una reseña en un libro que he leído **para** compartir mi opinión con otros usuarios.                                                                                                                                                                                         | **Scenario 1:** *Dejar reseña* <br> **Given** estoy en la página del libro <br> **When** escribo una reseña y la envío <br> **Then** la reseña se guarda y se muestra en la página del libro para que otros usuarios la vean. <br><br> **Scenario 2:** *Error al dejar reseña* <br> **Given** estoy en la página del libro <br> **When** hay un problema técnico o con la conexión <br> **Then** se muestra un mensaje de error y la reseña no se guarda. | Epic 3  |
| Story 008 | Leer Reseñas de Otros Usuarios         | **Como** usuario, **quiero** leer las reseñas de otros usuarios **para** tener una idea de la calidad del libro antes de adquirirlo.                                                                                                                                                                             | **Scenario 1:** *Leer reseñas* <br> **Given** estoy en la página del libro <br> **When** accedo a la sección de reseñas <br> **Then** puedo leer las reseñas escritas por otros usuarios. <br><br> **Scenario 2:** *Error al cargar reseñas* <br> **Given** estoy en la página del libro <br> **When** hay un problema con la carga de reseñas <br> **Then** se muestra un mensaje de error indicando que las reseñas no están disponibles. | Epic 3  |
| Story 009 | Enviar Mensajes a Otros Usuarios       | **Como** usuario, **quiero** enviar mensajes a otros usuarios **para** interactuar y discutir sobre libros y temas relacionados.                                                                                                                                                                               | **Scenario 1:** *Enviar mensaje* <br> **Given** estoy en la página de mensajes <br> **When** redacto un mensaje y lo envío <br> **Then** el mensaje se envía correctamente y el destinatario lo recibe. <br><br> **Scenario 2:** *Error en el envío de mensajes* <br> **Given** estoy en la página de mensajes <br> **When** hay un problema técnico <br> **Then** se muestra un mensaje de error y el mensaje no se envía. | Epic 3  |
| Story 010 | Recibir Notificaciones de Mensajes     | **Como** usuario, **quiero** recibir notificaciones cuando recibo nuevos mensajes **para** estar al tanto de las interacciones.                                                                                                                                                                                | **Scenario 1:** *Recibir notificación* <br> **Given** recibo un nuevo mensaje <br> **When** se envía la notificación <br> **Then** veo una notificación en la interfaz y en mi correo electrónico, si está habilitado. <br><br> **Scenario 2:** *Error en la notificación* <br> **Given** recibo un nuevo mensaje <br> **When** hay un problema con el envío de notificaciones <br> **Then** no recibo la notificación y se muestra un mensaje de error. | Epic 3  |
| Epic 4   | Funcionalidades de Compra               | **Como** usuario, **quiero** comprar libros a través de la plataforma **para** adquirir los títulos que me interesan.                                                                                                                                                                                          |                                                                                                                                                                                                                                                                                                                                                                                                                                  |          |
| Story 011 | Agregar Libro al Carrito                | **Como** usuario, **quiero** agregar libros a mi carrito de compras **para** revisar y comprar más tarde.                                                                                                                                                                                                         | **Scenario 1:** *Agregar libro al carrito* <br> **Given** estoy en la página del libro <br> **When** hago clic en el botón de agregar al carrito <br> **Then** el libro se añade a mi carrito y se actualiza el conteo de artículos. <br><br> **Scenario 2:** *Error al agregar al carrito* <br> **Given** estoy en la página del libro <br> **When** hay un problema técnico <br> **Then** se muestra un mensaje de error y el libro no se agrega al carrito. | Epic 4  |
| Story 012 | Proceder al Pago                       | **Como** usuario, **quiero** proceder al pago de mi carrito **para** completar la compra de los libros.                                                                                                                                                                                                           | **Scenario 1:** *Pago exitoso* <br> **Given** tengo libros en mi carrito <br> **When** procedo al pago y completo la información de pago <br> **Then** recibo una confirmación de compra y se actualiza mi historial de pedidos. <br><br> **Scenario 2:** *Error en el pago* <br> **Given** tengo libros en mi carrito <br> **When** hay un problema con el proceso de pago <br> **Then** se muestra un mensaje de error y no se completa la compra. | Epic 4  |
| Story 013 | Ver Historial de Compras                | **Como** usuario, **quiero** ver mi historial de compras **para** revisar los libros que he adquirido anteriormente.                                                                                                                                                                                             | **Scenario 1:** *Ver historial* <br> **Given** estoy en la página de historial de compras <br> **When** accedo a mi historial <br> **Then** puedo ver una lista de todas las compras realizadas con detalles de cada transacción. <br><br> **Scenario 2:** *Error al cargar historial* <br> **Given** estoy en la página de historial de compras <br> **When** hay un problema con la carga de información <br> **Then** se muestra un mensaje de error indicando que el historial no está disponible. | Epic 4  |
| Story 014 | Descargar Libro                         | **Como** usuario, **quiero** descargar los libros adquiridos **para** leerlos sin conexión.                                                                                                                                                                                                                   | **Scenario 1:** *Descarga exitosa* <br> **Given** he comprado un libro <br> **When** elijo descargar el libro <br> **Then** el libro se descarga en mi dispositivo y puedo acceder a él sin conexión. <br><br> **Scenario 2:** *Error en la descarga* <br> **Given** he comprado un libro <br> **When** hay un problema técnico durante la descarga <br> **Then** se muestra un mensaje de error y el libro no se descarga. | Epic 4  |
| Story 015 | Editar Información de Pago              | **Como** usuario, **quiero** editar la información de pago guardada **para** asegurarme de que los datos de pago estén actualizados.                                                                                                                                                                         | **Scenario 1:** *Editar información* <br> **Given** estoy en la página de gestión de información de pago <br> **When** actualizo mis datos de pago y envío los cambios <br> **Then** la información se actualiza y recibo una confirmación. <br><br> **Scenario 2:** *Error en la edición* <br> **Given** estoy en la página de gestión de información de pago <br> **When** hay un problema técnico <br> **Then** se muestra un mensaje de error y la información no se actualiza. | Epic 4  |
| Story 016 | Aplicar Código de Descuento             | **Como** usuario, **quiero** aplicar un código de descuento durante el pago **para** obtener una reducción en el precio total de mi compra.                                                                                                                                                                    | **Scenario 1:** *Aplicar descuento exitoso* <br> **Given** tengo un código de descuento válido <br> **When** aplico el código durante el proceso de pago <br> **Then** el descuento se aplica correctamente y se muestra el nuevo total. <br><br> **Scenario 2:** *Error en el descuento* <br> **Given** tengo un código de descuento inválido <br> **When** intento aplicarlo <br> **Then** se muestra un mensaje de error indicando que el código no es válido. | Epic 4  |
