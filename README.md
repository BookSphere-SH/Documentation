...
| Story 004 | Buscar Libros                         | **Como** estudiante, **quiero** buscar libros por título, autor o género **para** encontrar los libros que deseo leer.                                                                                                                                                                                              | **Scenario 1:** *Búsqueda exitosa* <br> **Given** estoy en la página de búsqueda <br> **When** ingreso un título, autor o género y envío la búsqueda <br> **Then** recibo una lista de libros que coinciden con los criterios de búsqueda. <br><br> **Scenario 2:** *Error en la búsqueda* <br> **Given** estoy en la página de búsqueda <br> **When** ingreso criterios de búsqueda inválidos <br> **Then** se muestra un mensaje de error indicando que no se encontraron resultados. | Epic 2  | Búsqueda por filtros, Manejo de errores |
| Story 005 | Filtrar Resultados de Búsqueda         | **Como** estudiante, **quiero** filtrar los resultados de búsqueda **para** refinar mi búsqueda y encontrar libros específicos.                                                                                                                                                                                   | **Scenario 1:** *Filtrado exitoso* <br> **Given** estoy en la página de resultados de búsqueda <br> **When** aplico filtros como precio, formato o calificación <br> **Then** la lista de resultados se actualiza para mostrar solo los libros que cumplen con los filtros aplicados. <br><br> **Scenario 2:** *Error en el filtrado* <br> **Given** estoy en la página de resultados de búsqueda <br> **When** aplico filtros inválidos <br> **Then** se muestra un mensaje de error indicando que los filtros no son válidos. | Epic 2  | Aplicación de filtros, Manejo de errores |
| Story 006 | Ver Detalles del Libro                 | **Como** estudiante, **quiero** ver los detalles de un libro **para** conocer más sobre su contenido y decidir si lo quiero adquirir.                                                                                                                                                                           | **Scenario 1:** *Ver detalles* <br> **Given** estoy en la página del libro <br> **When** accedo a la página del libro <br> **Then** puedo ver información detallada como título, autor, sinopsis, calificación y precio. <br><br> **Scenario 2:** *Error al cargar detalles* <br> **Given** estoy en la página del libro <br> **When** hay un problema con la carga de información <br> **Then** se muestra un mensaje de error indicando que los detalles no están disponibles. | Epic 2  | Visualización de datos, Manejo de errores |
| Epic 3   | Funcionalidades de Reseñas y Mensajes   | **Como** estudiante, **quiero** dejar reseñas y participar en discusiones **para** compartir mis opiniones y aprender de otros.                                                                                                                                                                                   |                                                                                                                                                                                                                                                                                                                                                                                                                                  |          |                        |
| Story 007 | Dejar Reseña en un Libro               | **Como** estudiante, **quiero** dejar una reseña en un libro que he leído **para** compartir mi opinión con otros usuarios.                                                                                                                                                                                         | **Scenario 1:** *Dejar reseña* <br> **Given** estoy en la página del libro <br> **When** escribo una reseña y la envío <br> **Then** la reseña se guarda y se muestra en la página del libro para que otros usuarios la vean. <br><br> **Scenario 2:** *Error al dejar reseña* <br> **Given** estoy en la página del libro <br> **When** hay un problema técnico o con la conexión <br> **Then** se muestra un mensaje de error y la reseña no se guarda. | Epic 3  | Publicación de reseñas, Manejo de errores |
| Story 008 | Leer Reseñas de Otros Usuarios         | **Como** estudiante, **quiero** leer las reseñas de otros estudiantes **para** tener una idea de la calidad del libro antes de adquirirlo.                                                                                                                                                                             | **Scenario 1:** *Leer reseñas* <br> **Given** estoy en la página del libro <br> **When** accedo a la sección de reseñas <br> **Then** puedo leer las reseñas escritas por otros usuarios. <br><br> **Scenario 2:** *Error al cargar reseñas* <br> **Given** estoy en la página del libro <br> **When** hay un problema con la carga de reseñas <br> **Then** se muestra un mensaje de error indicando que las reseñas no están disponibles. | Epic 3  | Visualización de reseñas, Manejo de errores |
...
| Story 010 | Recibir Notificaciones de Mensajes     | **Como** usuario, **quiero** recibir notificaciones cuando recibo nuevos mensajes **para** estar al tanto de las interacciones.                                                                                                                                                                                | **Scenario 1:** *Recibir notificación* <br> **Given** recibo un nuevo mensaje <br> **When** se envía la notificación <br> **Then** veo una notificación en la interfaz y en mi correo electrónico, si está habilitado. <br><br> **Scenario 2:** *Error en la notificación* <br> **Given** recibo un nuevo mensaje <br> **When** hay un problema con el envío de notificaciones <br> **Then** se muestra un mensaje de error y no recibo la notificación. | Epic 3  | Notificaciones, Manejo de errores |
| Epic 4   | Funcionalidades para Autores            | **Como** autor, **quiero** gestionar mis publicaciones y ver la retroalimentación de los lectores **para** mejorar mi trabajo y conectar con mi audiencia.                                                                                                                                                      |                                                                                                                                                                                                                                                                                                                                                                                                                                  |          |                        |
| Story 011 | Registrar un Nuevo Libro                | **Como** autor, **quiero** registrar un nuevo libro en la plataforma **para** que esté disponible para los usuarios.                                                                                                                                                                                                 | **Scenario 1:** *Registro exitoso* <br> **Given** estoy en la página de registro de libros <br> **When** completo los detalles del libro y envío el formulario <br> **Then** el libro se registra en la plataforma y está disponible para los usuarios. <br><br> **Scenario 2:** *Error en el registro* <br> **Given** estoy en la página de registro de libros <br> **When** ingreso datos inválidos o incompletos <br> **Then** se muestra un mensaje de error indicando qué información falta o es incorrecta. | Epic 4  | Registro de libro, Manejo de errores |
| Story 012 | Ver Estadísticas de Libros              | **Como** autor, **quiero** ver estadísticas de mis libros **para** analizar su rendimiento y la retroalimentación de los lectores.                                                                                                                                                                             | **Scenario 1:** *Ver estadísticas* <br> **Given** estoy en la página de estadísticas de mis libros <br> **When** accedo a las estadísticas <br> **Then** puedo ver gráficos y datos sobre ventas, calificaciones y reseñas. <br><br> **Scenario 2:** *Error al cargar estadísticas* <br> **Given** estoy en la página de estadísticas de mis libros <br> **When** hay un problema con la carga de datos <br> **Then** se muestra un mensaje de error y los datos no se cargan. | Epic 4  | Visualización de estadísticas, Manejo de errores |
| Story 013 | Responder a Reseñas de Lectores         | **Como** autor, **quiero** responder a las reseñas de los lectores **para** interactuar con ellos y ofrecer retroalimentación sobre sus comentarios.                                                                                                                                                               | **Scenario 1:** *Responder a reseña* <br> **Given** estoy en la página de reseñas de mi libro <br> **When** selecciono una reseña y escribo una respuesta <br> **Then** mi respuesta se publica y es visible para el lector y otros usuarios. <br><br> **Scenario 2:** *Error al responder* <br> **Given** estoy en la página de reseñas de mi libro <br> **When** hay un problema técnico <br> **Then** se muestra un mensaje de error y la respuesta no se publica. | Epic 4  | Respuesta a reseñas, Manejo de errores |
| Story 014 | Gestionar Mis Libros                    | **Como** autor, **quiero** gestionar mis libros registrados **para** realizar actualizaciones o eliminaciones según sea necesario.                                                                                                                                                                              | **Scenario 1:** *Actualizar libro* <br> **Given** estoy en la página de gestión de libros <br> **When** selecciono un libro para actualizar y envío los cambios <br> **Then** el libro se actualiza con la nueva información. <br><br> **Scenario 2:** *Eliminar libro* <br> **Given** estoy en la página de gestión de libros <br> **When** selecciono un libro para eliminar y confirmo la acción <br> **Then** el libro se elimina de la plataforma. | Epic 4  | Gestión de libros, Manejo de errores |
| Story 015 | Obtener Retroalimentación de Lectores   | **Como** autor, **quiero** obtener retroalimentación sobre mis libros **para** conocer la opinión de los lectores y mejorar mi trabajo.                                                                                                                                                                             | **Scenario 1:** *Recibir retroalimentación* <br> **Given** los lectores han dejado reseñas y comentarios <br> **When** accedo a la sección de retroalimentación de mis libros <br> **Then** puedo ver los comentarios y calificaciones de los lectores. <br><br> **Scenario 2:** *Error al cargar retroalimentación* <br> **Given** los lectores han dejado reseñas y comentarios <br> **When** hay un problema con la carga de retroalimentación <br> **Then** se muestra un mensaje de error indicando que la retroalimentación no está disponible. | Epic 4  | Retroalimentación, Manejo de errores |
| Story 016 | Gestionar Derechos de Publicación       | **Como** autor, **quiero** gestionar los derechos de publicación de mis libros **para** asegurarme de que mi trabajo esté protegido y adecuadamente distribuido.                                                                                                                                                        | **Scenario 1:** *Actualizar derechos* <br> **Given** estoy en la página de gestión de derechos de publicación <br> **When** actualizo la información de derechos y envío los cambios <br> **Then** la información se actualiza correctamente y se refleja en la plataforma. <br><br> **Scenario 2:** *Error al actualizar derechos* <br> **Given** estoy en la página de gestión de derechos de publicación <br> **When** hay un problema técnico <br> **Then** se muestra un mensaje de error y la información no se actualiza. | Epic 4  | Gestión de derechos, Manejo de errores |
| Story 017 | Ofrecer Descuentos en Libros            | **Como** autor, **quiero** ofrecer descuentos en mis libros **para** aumentar las ventas y atraer a más lectores.                                                                                                                                                                                                  | **Scenario 1:** *Aplicar descuento* <br> **Given** estoy en la página de gestión de precios <br> **When** configuro un descuento para uno o varios libros <br> **Then** el descuento se aplica y se muestra en la plataforma para los usuarios. <br><br> **Scenario 2:** *Error al aplicar descuento* <br> **Given** estoy en la página de gestión de precios <br> **When** hay un problema con la configuración del descuento <br> **Then** se muestra un mensaje de error y el descuento no se aplica. | Epic 4  | Descuentos, Manejo de errores |
| Story 018 | Ver y Gestionar Mis Contratos           | **Como** autor, **quiero** ver y gestionar mis contratos editoriales **para** asegurarme de que los términos y condiciones estén correctos y actualizados.                                                                                                                                                           | **Scenario 1:** *Ver contrato* <br> **Given** estoy en la página de gestión de contratos <br> **When** accedo a la sección de contratos <br> **Then** puedo ver los detalles de mis contratos editoriales. <br><br> **Scenario 2:** *Actualizar contrato* <br> **Given** estoy en la página de gestión de contratos <br> **When** actualizo la información de un contrato y envío los cambios <br> **Then** la información del contrato se actualiza correctamente y se refleja en la plataforma. <br><br> **Scenario 3:** *Error al gestionar contrato* <br> **Given** estoy en la página de gestión de contratos <br> **When** hay un problema técnico <br> **Then** se muestra un mensaje de error y la información del contrato no se actualiza. | Epic 4  | Gestión de contratos, Manejo de errores |
